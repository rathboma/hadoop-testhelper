//
// Original build file - Copyright 2012 Damian Helme
// Modifications - copyright 2013 Matthew Rathbone
//
...
libraryDependencies ++= {
    Seq(
        "org.apache.hadoop" % "hadoop-client" % "2.0.0-mr1-cdh4.4.0" % "provided"
    )
}
